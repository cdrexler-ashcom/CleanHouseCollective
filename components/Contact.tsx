  ...
  return (
    <section id="contact" className="section">
      <div className="container-page">
        <div className="relative overflow-hidden rounded-3xl bg-emerald px-8 py-14 text-cream shadow-soft-lg lg:px-16 lg:py-20">
          ...
          <div className="relative grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <button
                type="button"
                onClick={open}
                className="mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-cream px-7 py-3.5 text-sm font-semibold text-emerald transition-all hover:bg-white hover:shadow-soft-lg active:scale-[0.98]"
              >
                Get a Free Quote
            ...
            <div className="grid gap-4">
              {methods.map((method) => (
                <a
                  key={method.label}
                  href={method.href}
                  className="flex items-center gap-4 rounded-2xl border border-white/15 bg-white/10 px-6 py-5 backdrop-blur-sm transition-colors hover:bg-white/20"
                >
